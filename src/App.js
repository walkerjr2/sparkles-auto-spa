                ...
                <div className="mt-4 space-x-4 flex justify-center">
                  ...
                  >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6">
                      <path fill="#fff" d="M380.9 97.1C339-2.6 225.2-32 135.4 9.9 45.6 51.8 15.2 165.6 57.1 255.4l-36.7 100.7c-4.2 11.6 7.5 22.2 19.1 18l100.7-36.7c89.8 41.9 203.6 11.5 245.5-78.3 41.9-89.8 11.5-203.6-78.3-245.5zm-154.7 319.7c-36.2 0-71.7-10.7-102.1-30.8l-7.2-4.6-59.8 21.8 21.8-59.8-4.6-7.2c-20.1-30.4-30.8-65.9-30.8-102.1 0-106.1 86.3-192.4 192.4-192.4s192.4 86.3 192.4 192.4-86.3 192.4-192.4 192.4zm107.6-146.7c-3-1.5-17.7-8.7-20.5-9.7-2.8-1-4.8-1.5-6.8 1.5-2 3-7.8 9.7-9.6 11.7-1.8 2-3.5 2.2-6.5.7-3-1.5-12.7-4.7-24.2-15-9-8-15.1-17.8-16.9-20.8-1.8-3-0.2-4.6 1.3-6.1 1.3-1.3 3-3.5 4.5-5.2 1.5-1.7 2-2.9 3-4.8 1-1.9 0.5-3.7-0.2-5.2-.7-1.5-6.8-16.4-9.3-22.5-2.5-6-5-5.2-6.8-5.3-1.8-0.1-3.7-0.1-5.7-0.1s-5.2 0.7-7.9 3.7c-2.7 3-10.4 10.2-10.4 24.9s10.7 28.8 12.2 30.8c1.5 2 21.1 32.2 51.2 45.1 7.2 3.1 12.8 5 17.2 6.4 7.2 2.3 13.8 2 19-1.2 5.2-3.2 8.5-7.8 9.7-11.1 1.2-3.3 1.2-6.1 0.8-6.7-.4-0.6-2.7-1.5-5.7-3z"/>
                    </svg>
                    WhatsApp
                  </a>
                  <a
                  ...
                  >
                    {/* Improved Instagram SVG Icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6">
                      <defs>
                        <radialGradient id="insta-gradient" cx="30%" cy="107%" r="150%" fx="30%" fy="107%">
                      ...
                      <path fill="url(#insta-gradient)" d="M224.1 141c-63.6 0-115 51.4-115 115 0 63.6 51.4 115 115 115 63.6 0 115-51.4 115-115 0-63.6-51.4-115-115-115zm0 190c-41.6 0-75-33.4-75-75s33.4-75 75-75 75 33.4 75 75-33.4 75-75 75zm146.4-194.3c0 14.9-12.1 27-27 27-14.9 0-27-12.1-27-27s12.1-27 27-27 27 12.1 27 27zm76.1 27.2c-1.7-35.3-9.9-66.7-36.2-92.9C397.7 9.9 366.3 1.7 331 0 295.7-1.7 256.3-1.7 221 0c-35.3 1.7-66.7 9.9-92.9 36.2C9.9 114.3 1.7 145.7 0 181c-1.7 35.3-1.7 74.7 0 110 1.7 35.3 9.9 66.7 36.2 92.9 26.2 26.2 57.6 34.4 92.9 36.2 35.3 1.7 74.7 1.7 110 0 35.3-1.7 66.7-9.9 92.9-36.2 26.2-26.2 34.4-57.6 36.2-92.9 1.7-35.3 1.7-74.7 0-110zm-48.5 268c-7.8 19.6-23.1 35-42.7 42.7-29.5 11.7-99.5 9-132.3 9s-102.8 2.7-132.3-9c-19.6-7.8-35-23.1-42.7-42.7-11.7-29.5-9-99.5-9-132.3s-2.7-102.8 9-132.3c7.8-19.6 23.1-35 42.7-42.7 29.5-11.7 99.5-9 132.3-9s102.8-2.7 132.3 9c19.6 7.8 35 23.1 42.7 42.7 11.7 29.5 9 99.5 9 132.3s2.7 102.8-9 132.3z"/>
                    </svg>
                    Instagram
                  </a>
                </div>
